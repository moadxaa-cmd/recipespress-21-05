...
export const Settings: React.FC<SettingsProps> = (props) => {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'gemini':
                return <GeminiApiKeySettings geminiApiKey={props.geminiApiKey} setGeminiApiKey={props.setGeminiApiKey} showToast={props.showToast} isQueuePaused={isQueuePaused} />;
            case 'articleAgent':
